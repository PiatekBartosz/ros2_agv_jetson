...
static size_t _NormalizedImageCrop_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_depthai_ros_msgs__srv__NormalizedImageCrop_Request(
    full_bounded, 0);
}
...
static size_t _NormalizedImageCrop_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_depthai_ros_msgs__srv__NormalizedImageCrop_Response(
    full_bounded, 0);
}
