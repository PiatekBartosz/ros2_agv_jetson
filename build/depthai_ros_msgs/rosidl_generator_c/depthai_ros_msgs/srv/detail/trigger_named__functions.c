  ...
  depthai_ros_msgs__srv__TriggerNamed_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    depthai_ros_msgs__srv__TriggerNamed_Request * data =
      (depthai_ros_msgs__srv__TriggerNamed_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!depthai_ros_msgs__srv__TriggerNamed_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          depthai_ros_msgs__srv__TriggerNamed_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  depthai_ros_msgs__srv__TriggerNamed_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    depthai_ros_msgs__srv__TriggerNamed_Response * data =
      (depthai_ros_msgs__srv__TriggerNamed_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!depthai_ros_msgs__srv__TriggerNamed_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          depthai_ros_msgs__srv__TriggerNamed_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
