...
struct SpatialDetectionArray_
{
  ...
  using _detections_type =
    std::vector<depthai_ros_msgs::msg::SpatialDetection_<ContainerAllocator>, typename ContainerAllocator::template rebind<depthai_ros_msgs::msg::SpatialDetection_<ContainerAllocator>>::other>;
  ...
  Type & set__detections(
    const std::vector<depthai_ros_msgs::msg::SpatialDetection_<ContainerAllocator>, typename ContainerAllocator::template rebind<depthai_ros_msgs::msg::SpatialDetection_<ContainerAllocator>>::other> & _arg)
  {
