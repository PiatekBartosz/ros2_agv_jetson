...
struct HandLandmarkArray_
{
  ...
  using _landmarks_type =
    std::vector<depthai_ros_msgs::msg::HandLandmark_<ContainerAllocator>, typename ContainerAllocator::template rebind<depthai_ros_msgs::msg::HandLandmark_<ContainerAllocator>>::other>;
  ...
  Type & set__landmarks(
    const std::vector<depthai_ros_msgs::msg::HandLandmark_<ContainerAllocator>, typename ContainerAllocator::template rebind<depthai_ros_msgs::msg::HandLandmark_<ContainerAllocator>>::other> & _arg)
  {
    this->landmarks = _arg;
    return *this;
  }
